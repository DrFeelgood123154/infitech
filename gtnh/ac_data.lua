...
addItem("Cosmic Neutronium Rod", IMPORTANT, 10e4)
addItem("Tairitsu Rod", IMPORTANT, 10e4)
addItem("Transcendent Metal Rod", IMPORTANT, 10e4)
addItem("Botmium Plate", IMPORTANT, 10e4)
addItem("Arcanite Screw", IMPORTANT, 10e4)
addItem("Ender-Quantum Component", IMPORTANT, 10e4)
